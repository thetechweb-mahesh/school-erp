...
use App\Http\Controllers\admin\StudentPanelController;
Route::get('/', function () {
    return view('welcome');
});
...
Route::middleware(['auth', 'role:student'])
    ...
    Route::get('/dashboard', [StudentPanelController::class, 'dashboard'])
        ->name('dashboard');

    Route::get('/fees', [StudentPanelController::class, 'fees'])
        ->name('fees');

    Route::get('/attendance', [StudentPanelController::class, 'attendance'])
        ->name('attendance');
});
...
// Export Excel
Route::get('/admin/fee-collection/export-excel', [FeePaymentController::class, 'exportExcel'])
    ->name('fee.export.excel');

// ✅ Export PDF (ADD THIS)
Route::get('/admin/fee-collection/export-pdf', [FeePaymentController::class, 'exportPdf'])
    ->name('fee.export.pdf');
